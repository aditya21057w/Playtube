...
namespace PlayTube.MediaPlayers.Exo
{
    public class ExoController
    {
        ...
        private StyledPlayerView PlayerView, FullScreenPlayerView;
        ...
        public ExoController(AppCompatActivity context, StyledPlayerView playerView, string typePage = "normal")
        {
            try
            {
        ...
        public void SetPlayer(bool useController = true)
        {
            try
            {
                ...
                var playerListener = new PlayerEvents(ActivityContext, ControlView);
        ...
        public void SetFullScreenPlayerView(StyledPlayerView playerView)
        {
            try
            {
                FullScreenPlayerView = playerView;

                ControlView = FullScreenPlayerView.FindViewById<StyledPlayerControlView>(Resource.Id.exo_controller);
