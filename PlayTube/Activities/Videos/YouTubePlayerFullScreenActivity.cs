    ...
    public class YouTubePlayerFullScreenActivity : AppCompatActivity, IYouTubePlayerInitListener, IYouTubePlayerFullScreenListener
    {
        ...
        public void OnInitSuccess(IYouTubePlayer youTubePlayer)
        {
            try
            {
                ...
                PlayerEvents = new YouTubePlayerEvents(YouTubePlayer, VideoIdYoutube, "FullScreen", CurrentSecond);
        ...
        public void OnYouTubePlayerExitFullScreen()
        {
            try
            {
                ...
                if (instance != null)
                {
                    instance.YouTubePlayerEvents.CurrentSecond = PlayerEvents.CurrentSecond;
                    instance.YouTubePlayerEvents.IsPlaying = PlayerEvents.IsPlaying;
                }
