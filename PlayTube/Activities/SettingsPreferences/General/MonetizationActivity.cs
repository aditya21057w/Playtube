...
namespace PlayTube.Activities.SettingsPreferences.General
{
    ...
    public class MonetizationActivity : BaseActivity
    {
        ...
        private AppCompatButton SendText;
        ...
        protected override void OnResume()
        {
            try
            {
                ...
                AdsGoogle.LifecycleAdManagerAdView(MAdView, "Resume");
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
        ...
        protected override void OnPause()
        {
            try
            {
                ...
                AdsGoogle.LifecycleAdManagerAdView(MAdView, "Pause");
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
        ...
        protected override void OnDestroy()
        {
            try
            {
                AdsGoogle.LifecycleAdManagerAdView(MAdView, "Destroy");
                base.OnDestroy();
            }
        ...
        private void InitComponent()
        {
            try
            {
                SendText = FindViewById<AppCompatButton>(Resource.Id.toolbar_title);
                ...
                MAdView = FindViewById<AdManagerAdView>(Resource.Id.adView);
